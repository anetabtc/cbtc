...
export const update = async (lucid: Lucid) => {
	...
	const configUpdate: ConfigUpdate = {
		unit: "9622668f11e1c49d493a22b140d5cc345c8329dfd8494bc5c0fa80194d756c746953696743657274",
		oldCosignerKeys: [
			// lucid.utils.paymentCredentialOf(signers.account1.address).hash,
...
export const fullfil = async (lucid: Lucid) => {
	const multiSigCertUnit = "6ae33efc0218cb4cacd4185d7efa26e3615a924655beb7d875f41f354d756c7469536967"
