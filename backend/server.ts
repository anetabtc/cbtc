...
function Run({ lucid }: Props){
	(async () => {
		...
		while(true){
			...
			// TODO - Print to user
			console.log("Willie:")
			let ada_addr = "addr_test1qr93h9esl962tww08u0q4nv7hd6w9cr6vg2q5aqvkw05qv436ujy2pp7syywu3u53zlutqhsg8gw8nrrxukl2eg27v8sf3q42k" //"addr_test1qqxm6xdfgy9700tal3je94s7eqeusu08cku0rkvmsqkldytj60xr5crz6tmy995kskqtgukfhjearmcejld8z0wzsegqkp23xu"
			let paymentCreds = lucid.utils.paymentCredentialOf(ada_addr)
			console.log(paymentCreds.hash)
			console.log(lucid.utils.credentialToAddress(paymentCreds))

			if(epoch >= 1){  // TODO production: change to 5
