...
export const build = async (lucid, guardianDatumUtxoList, config) => {
    const info = {
        multisigVal: {
        ...
        cBTCMint: {
            ...
            unit: toUnit(lucid.utils.mintingPolicyToId(config.scripts.cBTCMintingPolicy), fromText("cBTC")),
    ...
    const multisigValTx = lucid
        ...
        .payToContract(info.multisigVal.address, { inline: info.multisigVal.utxo.datum || "" }, info.multisigVal.utxo.assets);
